...
void setRoutineScreenToToday() {
  ...
  final daysDifference = today.difference(referenceDay).inDays;

  // 인덱스 15가 기준일이므로 오늘 인덱스 = 15 + daysDifference
  final todayIndex = 15 + daysDifference;
